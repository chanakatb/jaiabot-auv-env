...
gym.register(
    ...
    entry_point="isaaclab_tasks.direct.isaac_auv_env:WarpAUVEnv",  # Changed from isaac-auv-env
...
gym.register(
    ...
    entry_point="isaaclab_tasks.direct.isaac_auv_env:SurfaceVehicleEnv",  # Changed from isaac-auv-env
    disable_env_checker=True,
    kwargs={
